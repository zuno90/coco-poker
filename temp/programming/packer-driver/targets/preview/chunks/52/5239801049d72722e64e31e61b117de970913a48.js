      ...
      _export("Login", Login = (_dec = ccclass("Login"), _dec(_class = class Login extends Component {
        ...
        get() {
          return _asyncToGenerator(function* () {
            var a = yield fetch('https://sv-user.dadsnetwork.co/api/auth/google/url?redirect_url=https://dads-user.vercel.app').then(value => {
              console.log(value.json(), "Checl a");
            });
          })();
        }
...
//# sourceMappingURL=5239801049d72722e64e31e61b117de970913a48.js.map