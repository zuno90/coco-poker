System.register(["__unresolved_0", "cc", "__unresolved_1"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, director, Node, Prefab, EPokerScene, _dec, _dec2, _dec3, _dec4, _dec5, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _crd, ccclass, property, Setting;
  ...
  return {
    ...
    execute: function () {
      ...
      __checkObsolete__(['_decorator', 'Component', 'director', 'Node', 'Prefab']);
      ...
      _export("Setting", Setting = (_dec = ccclass("Setting"), _dec2 = property(Node), _dec3 = property(Prefab), _dec4 = property(Prefab), _dec5 = property(Prefab), _dec(_class = (_class2 = class Setting extends Component {
        ...
        changeTab(e, tab) {
          console.log(tab);
          this.settingLayout.removeAllChildren(); // switch (tab) {
          //   case :
          // }
        }
...
//# sourceMappingURL=7589154fb074ae35dba5f8dc18ccead438746b35.js.map